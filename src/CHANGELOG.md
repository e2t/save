...
- Номер змін тепер відображається на кресленні у двочисельному вигляді (00, 01...)

## [3.14.0] 2022-12-21

### Изменения

- В имени XLS-спецификаций теперь отсутствует код документа (СБ, МЧ и т.д.). Например, для сборочного чертежа `ABC.123СБ` будет создана спецификация `ABC.123`.

## [3.13] 2022-05-16

### Добавлено

- Из создаваемых файлов PDF теперь удаляются метаданные.
